...
%% Test 2 GOOD
%Does the test produce feasible results in many iterations? 
%Success: Only 6 in the final output.
pop = [1,2,3;4,5,6;7,8,6];
mutVector = [0,1,1,1];
test2 = pop;
for i = 1:5
...
%Revealed potential bug with mutVector - got a num2 value of 8.
%Question: do all things mutate when a mut is rolled?
